...
class Module extends AbstractModule
{
    ...
    {
        $sql = <<<'SQL'
CREATE TABLE redact_values_redaction (id INT UNSIGNED AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, property_id INT NOT NULL, pattern_id INT UNSIGNED DEFAULT NULL, `label` VARCHAR(255) NOT NULL, resource_type VARCHAR(255) NOT NULL, query LONGTEXT NOT NULL, replacement VARCHAR(255) NOT NULL, allow_roles LONGTEXT NOT NULL COMMENT '(DC2Type:json)', created DATETIME NOT NULL, modified DATETIME DEFAULT NULL, INDEX IDX_B4972C27E3C61F9 (owner_id), INDEX IDX_B4972C2549213EC (property_id), INDEX IDX_B4972C2F734A20F (pattern_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
