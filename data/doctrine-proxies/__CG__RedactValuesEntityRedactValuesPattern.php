 ...
 */
class RedactValuesPattern extends \RedactValues\Entity\RedactValuesPattern implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'owner', 'label', 'pattern', 'created', 'modified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RedactValuesPattern $proxy) {
